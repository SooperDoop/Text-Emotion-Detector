...
def index1():
    ...
    return render_template('index.html',text1=data,ang=data1[0][0]*100,dis=data1[0][1]*100,fea=data1[0][2]*100,
                           gui=data1[0][3]*100,joy=data1[0][5]*100,sad=data1[0][6]*100,sha=data1[0][7]*100)
